...
const VIEWS = {
    ...
    logincrack: '#logincrackContainer',
  ...
  if (selectedAcc != null) {
    ...
    if (!val) {
      ...
      setOverlayContent(
        ...
        `We were unable to refresh the login for <strong>${selectedAcc.displayName}</strong>. Please ${
      ...
      setOverlayHandler(() => {
        ...
        if (isMicrosoft) {
          ...
          // Add the account with the username
          AuthManager.addMojangAccount(selectedAcc.username, '').then((value) => {
            ...
            console.error('Error adding Mojang account:', error);
          });
        }
